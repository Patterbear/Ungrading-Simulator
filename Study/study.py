...
def run():
    ...
    des_txt = open("Study/des.txt", 'r', encoding="utf8")
    description = des_txt.read()

    topic1_txt = open("Study/topic1.txt", 'r', encoding="utf8")
    topic_1 = topic1_txt.read()

    topic2_txt = open("Study/topic2.txt", 'r', encoding="utf8")
    topic_2 = topic2_txt.read()

    topic3_txt = open("Study/topic3.txt", 'r', encoding="utf8")
    topic_3 = topic3_txt.read()

    topic4_txt = open("Study/topic4.txt", 'r', encoding="utf8")
    topic_4 = topic4_txt.read()

    topic5_txt = open("Study/topic5.txt", 'r', encoding="utf8")
